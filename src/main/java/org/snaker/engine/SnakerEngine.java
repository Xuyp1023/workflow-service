...
public interface SnakerEngine {
	 ...
	 * @return Order 流程实例
	 */
	public Order startInstanceByName(String name, Long custNo);
	 ...
	 * @return Order 流程实例
	 */
	public Order startInstanceByName(String name, Long custNo, Integer version);
	 ...
	 * @return Order 流程实例
	 */
	public Order startInstanceByName(String name, Long custNo, Integer version, String operator);
	 ...
	 * @return Order 流程实例
	 */
	public Order startInstanceByName(String name, Long custNo, Integer version, String operator, Map<String, Object> args);
