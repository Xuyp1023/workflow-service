...
public abstract class AbstractDBAccess implements DBAccess {
	...
	protected static final String PROCESS_INSERT = "insert into wf_process (id,name,display_Name,type,instance_Url,state,version,create_Time,creator,custNo) values (?,?,?,?,?,?,?,?,?,?)";
