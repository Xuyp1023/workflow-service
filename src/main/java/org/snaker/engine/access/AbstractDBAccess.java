...
public abstract class AbstractDBAccess implements DBAccess {
    ...
    public void saveProcess(final Process process) {
        if (isORM()) {
            ...
            final Object[] args = new Object[] { process.getId(), process.getName(), process.getDisplayName(),
                    process.getType(), process.getInstanceUrl(), process.getState(), process.getVersion(),
                    process.getCreateTime(), process.getCreator(), process.getCustNo() };
            final int[] type = new int[] { Types.VARCHAR, Types.VARCHAR, Types.VARCHAR, Types.INTEGER, Types.VARCHAR,
                    Types.INTEGER, Types.INTEGER, Types.VARCHAR, Types.VARCHAR, Types.BIGINT };
    ...
    public void updateProcess(final Process process) {
        if (isORM()) {
            ...
            final int[] type = new int[] { Types.VARCHAR, Types.VARCHAR, Types.INTEGER, Types.VARCHAR, Types.VARCHAR,
    ...
    public void saveTask(final Task task) {
        if (isORM()) {
            ...
            final Object[] args = new Object[] { task.getId(), task.getOrderId(), task.getTaskName(),
                    task.getDisplayName(), task.getTaskType(), task.getPerformType(), task.getOperator(),
                    task.getCreateTime(), task.getFinishTime(), task.getExpireTime(), task.getActionUrl(),
                    task.getParentTaskId(), task.getVariable(), task.getVersion() };
    ...
    public void saveOrder(final Order order) {
        if (isORM()) {
            ...
            final Object[] args = new Object[] { order.getId(), order.getProcessId(), order.getCreator(),
    ...
    public void updateTask(final Task task) {
        if (isORM()) {
            ...
            final Object[] args = new Object[] { task.getFinishTime(), task.getOperator(), task.getVariable(),
    ...
    public void updateOrder(final Order order) {
        if (isORM()) {
            ...
            final Object[] args = new Object[] { order.getLastUpdator(), order.getLastUpdateTime(), order.getVariable(),
    ...
    public void updateCCOrder(final CCOrder ccorder) {
        if (isORM()) {
            ...
            final Object[] args = new Object[] { ccorder.getStatus(), ccorder.getFinishTime(), ccorder.getOrderId(),
                    ccorder.getActorId() };
    ...
    public void saveHistory(final HistoryOrder order) {
        if (isORM()) {
            ...
            final Object[] args = new Object[] { order.getId(), order.getProcessId(), order.getOrderState(),
    ...
    public void updateHistory(final HistoryOrder order) {
        if (isORM()) {
            ...
            final Object[] args = new Object[] { order.getOrderState(), order.getEndTime(), order.getVariable(),
                    order.getId() };
            final int[] type = new int[] { Types.INTEGER, Types.VARCHAR, Types.VARCHAR, Types.VARCHAR };
    ...
    public void saveHistory(final HistoryTask task) {
        if (isORM()) {
            ...
            final Object[] args = new Object[] { task.getId(), task.getOrderId(), task.getTaskName(),
                    task.getDisplayName(), task.getTaskType(), task.getPerformType(), task.getTaskState(),
                    task.getOperator(), task.getCreateTime(), task.getFinishTime(), task.getExpireTime(),
                    task.getActionUrl(), task.getParentTaskId(), task.getVariable() };
            final int[] type = new int[] { Types.VARCHAR, Types.VARCHAR, Types.VARCHAR, Types.VARCHAR, Types.INTEGER,
    ...
    public void updateSurrogate(final Surrogate surrogate) {
        if (isORM()) {
            ...
            final Object[] args = new Object[] { surrogate.getProcessName(), surrogate.getSurrogate(),
    ...
    @Override
    public <T> List<T> queryList(final Page<T> page, final QueryFilter filter, final Class<T> clazz, final String sql,
            final Object... args) {
