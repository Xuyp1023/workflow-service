 ...
 *
 */
@Service("demoApplyFormHandler")
public class ApplyFormHandler implements INodeHandler {
    ...
    public void processPass(final Map<String, Object> anContext) {
        ...
        System.out.println("Demo ApplyForm Handler:" + anContext);

        anContext.put(RESULT, "结果 ApplyForm");
    }
